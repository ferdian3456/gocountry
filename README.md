...
2. Already sorted in alphabetical order

## Future Enhancment
1. Cache data into redis, memcached, or any in memory database
2. You can provide a end point that retrieve this data so user wont type their own country codes.
